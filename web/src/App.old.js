...
import SNMP from './components/SNMP/SNMP';
import WindowsEvents from './components/WindowsEvents';
...
const App = () => {
  ...
  const menuItems = [
    ...
    { path: '/buffer', label: 'Buffer Status', icon: '🗄️' },
    ...
    <div className="app" data-testid="app-loaded">
      ...
      <div className="main-content">
        <Routes>
          ...
          <Route path="/dashboard" element={<DashboardComp systemStatus={status || {}} />} />
